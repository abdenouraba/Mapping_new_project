 ...
 * @author pc acer
 */
public class Class_NocArchitecteur_2D_WITHOUT_WIFI{
    ...
    public Class_NocArchitecteur_2D_WITHOUT_WIFI(int axe_x,int axe_y, double Eneregy_in_router,double Energey_in_link,double Wight_Traffic,double bandwith_between_pe){
    this.axe_x=axe_x;
    this.axe_y=axe_y;
    ...
    public Class_NocArchitecteur_2D_WITHOUT_WIFI(int axe_x, int axe_y){
    this.axe_x=axe_x;
    this.axe_y=axe_y;
    }
