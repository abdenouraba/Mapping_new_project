...
public class Class_mappage_2D {
  ...
  //  private ArrayList<Class_noued>  Noc_architecteur[][];
    ...
    private Class_NocArchitecteur_2D_WITHOUT_WIFI Noc;
    
    
    
    @SuppressWarnings("unchecked")
    public Class_mappage_2D(Class_Dnn Dnn_modele, Class_NocArchitecteur_2D_WITHOUT_WIFI Noc_architecteur){
    ...
    System.out.println("id de neuron n° "+j+" : "+one_Layer.get(j).getId_noued());
     ...
     public double Eneregy_in_one_neuron_in_on_pe(Class_noued neuron){
        ...
        for(int i=0;i<size;i++){
          ...
          // System.out.println("la position de neuron source est "+neuron.getId_noued()  +"   la positioon de neuron distination est :"+pos+" leur id est "+list_voisin.get(i).getnoued_destination().getId_noued());
...
*/
     ...
     public Class_NocArchitecteur_2D_WITHOUT_WIFI getNoc(){
     return this.Noc; 
     }
